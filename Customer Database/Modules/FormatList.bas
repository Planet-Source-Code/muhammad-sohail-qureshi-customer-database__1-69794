...
Public Const vblightred = &HC1B9FB
Public Const vblightblack = &HE7E7E7
...
On Error GoTo SetListViewColor_Error
    ...
    If pCtrlListView.View = lvwReport Then
        ...
        With pCtrlPictureBox.Font
            .Size = pCtrlListView.Font.Size + 1#
...
Public Sub SetListViewColorShort(pCtrlListView As ListView, _
                            pCtrlPictureBox As PictureBox, _
                            Color1 As Long, _
                            Color2 As Long)
